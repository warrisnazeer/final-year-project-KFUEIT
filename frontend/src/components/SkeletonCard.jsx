export default function SkeletonCard({ featured = false }) {
  return (
    <div className={`bg-white border border-brand-border rounded-xl overflow-hidden animate-pulse shadow-sm`}>
      {featured && <div className="w-full h-44 bg-slate-200/70" />}
      <div className="p-4 space-y-3">
        <div className="flex gap-2">
          <div className="h-3.5 bg-slate-200 rounded-full w-14" />
          <div className="h-3.5 bg-slate-200 rounded-full w-10" />
        </div>
